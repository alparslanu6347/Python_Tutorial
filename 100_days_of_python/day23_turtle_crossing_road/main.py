...
while game_is_on:
    ...
    # detect successfull crossing (detect when turtle reaches the other side)
...
# When this happens, return the turtle to the starting position and
# increase the speed of the cars.
# Hint: think about creating an attribute and
# using the MOVE_INCREMENT to increase the car speed.
# If you get stuck, check the video walkthrough in Step 6.

# step 5   = detect when turtle reaches the other side - create scroeboard
